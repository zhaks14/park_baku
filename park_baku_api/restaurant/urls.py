...
from .views import CustomerViewSet,check_or_create_customer, verify_code,createOrder,getBalance,orderHistory,sendCode,verifyCode,popularDishes,createOrderWithDishes,check_customer,customer_profile,redeem_bonus,add_bonus
